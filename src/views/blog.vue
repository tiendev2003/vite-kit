<template>
    ...
    <div class="pagination">
        <vue-awesome-paginate :total-items="total" :max-pages-shown="3" v-model="page" :show-breakpoint-buttons="false"
...
.blog-card {
    ...
    border-radius: 25px;
    background: white;
    box-shadow: 0px 10px 50px rgba(42, 109, 253, 0.3);
}
...
.inner-part .img {
    ...
    box-shadow: 2px 3px 15px rgba(38, 163, 246, 0.1);
}
...
.main-content button {
    ...
    cursor: pointer;
    outline: none;
    border: 1px solid #2176c0e5;
    background: linear-gradient(147deg, #337bed 0%, #208ef5 74%);
}
