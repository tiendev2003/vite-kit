...
<template>
  <section class="home" id="home">
    <div class="home-text">
      ...
      <p>
        We're professional Korean-speaking bridge engineers in VKU - FPT, and
        We're very passionate <br />
        and dedicated to our work.
      </p>
      <router-link :to="{ name: 'home' }" class="top-btn">
        Explorer</router-link
      >
      <router-link :to="{ name: 'home' }" class="top-btn">
        Watch Demo</router-link
      >
    </div>
    <div class="home-img">
  ...
  <section class="student">
    <div class="main-people">
      <div class="people">
        ...
        >
          <img
            :src="'https://cdn.vku-udn.edu.vn/daotao/sinhvien/' + item.image"
        ...
        >
          <div class="card">
            <div class="imgBx" @click="handleClick(index)">
              <img
                :src="
                  'https://cdn.vku-udn.edu.vn/daotao/sinhvien/' + item.image
                "
                :alt="'ảnh của ' + item.name"
              />
            </div>
