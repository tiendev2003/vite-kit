...
export default {
    ...
    methods: {
        ...
        async registerUser(event) {
            ...
            if (!this.validateName(event.target[0].value) || !this.validateEmail(event.target[1].value)) {
                return;
            }
        ...
        <div class="form login">
            <div class="form-content">
                ...
                <form @submit.prevent="loginUser">
                    ...
                    <div class="field input-field">
                        <input :type="showPassword ? 'text' : 'password'" placeholder="Password" @keyup="validatePassword" class="password" v-model="password" />
                        <i class="pi pi-eye eye-icon" @click="togglePassword" v-if="showPassword"></i>
                        <i class="pi pi-eye-slash eye-icon" v-else @click="togglePassword"></i>
                    </div>
                ...
                <div class="form-link">
                    <span>Bạn chưa có tài khoản? <a style="cursor: pointer" @click="toggleSignup()" class="link signup-link">Đăng ký</a></span>
                </div>
            </div>
            <div class="line"></div>
            <div class="media-options">
                <a href="#" class="field facebook">
                    <img src="@/assets/icons/facebook.svg" alt="" class="google-img" />
        ...
        <div class="form signup">
            <div class="form-content">
                ...
                <form @submit.prevent="registerUser">
                    <div class="field input-field">
                        <input type="text" placeholder="Họ và tên" class="input" v-model="name" />
                    </div>
                    <div class="field input-field">
                        <input type="email" placeholder="Email" class="input" v-model="email" />
                    </div>
                    <div class="field input-field">
                        <input :type="showPassword ? 'text' : 'password'" placeholder="Nhập mật khẩu" class="password" v-model="password" @keyup="validatePassword" />
                        <i class="pi pi-eye eye-icon" @click="togglePassword" v-if="showPassword"></i>
                        <i class="pi pi-eye-slash eye-icon" v-else @click="togglePassword"></i>
                    </div>
                    <div v-if="email_error" style="color: red">
                    ...
                    <div v-if="errorMessage" class="strength-validation" :class="validator ? errorMessage : ''">
                ...
                <div class="form-link">
                    <span>Bạn đã có tài khoản? <a @click="toggleSignup()" href="#" class="link login-link">Đăng nhập</a></span>
                </div>
            </div>
            <div class="line"></div>
            <div class="media-options">
