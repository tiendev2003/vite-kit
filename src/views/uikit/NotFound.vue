        ...
        <div class="flex flex-column align-items-center justify-content-center">
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, rgba(33, 150, 243, 0.4) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style="border-radius: 53px">
                    ...
                    <h1 class="text-900 font-bold text-3xl lg:text-5xl mb-2">Không tìm thấy trang bạn muốn tìm</h1>
                    <div class="text-600 mb-5">Request không hợp lệ.</div>
                    <router-link to="/" class="w-full flex align-items-center py-5 border-300 border-bottom-1 justify-content-center">
                        ...
                        <span class="ml-4 flex flex-column">
                            <span class="text-900 lg:text-xl font-medium mb-0 block">Trở về trang chủ</span>
                        </span>
                    </router-link>
                </div>
            </div>
